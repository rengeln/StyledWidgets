...
#include "StyledActivatableWidget.generated.h"
...
class STYLEDWIDGETS_API UStyledActivatableWidget
	: public UCommonActivatableWidget
	, public TStyledWidgetBase<UStyledActivatableWidget>
	, public IStyledWidgetInterface
{
	GENERATED_BODY()

public:
	UStyledActivatableWidget(FObjectInitializer const& Initializer);
